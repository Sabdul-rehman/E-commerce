...
.form-light-red {
    background: linear-gradient(150deg, #ffeaea 0%, #cc4646 100%);
    color: #000;
}
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 background_color">
                <h1 class="d-flex justify-content-center m-3" style="font-size: 40px">Home Page Form</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            {{-- home page categories --}}
                              <div class="mb-3">
                                    <label class="form-label fw-bold">Choose Home page Category</label>
                                    <select name="category" class="form-select @error('category') is-invalid @enderror">
                                        <option value="">Select a category</option>
                                        <option value="stitched" {{ old('category') == 'stitched' ? 'selected' : '' }}>None</option>
                                        <option value="unstitched" {{ old('category') == 'unstitched' ? 'selected' : '' }}>Latest product</option>
                                        <option value="unstitched" {{ old('category') == 'unstitched' ? 'selected' : '' }}>Bestsellers of the Month</option>
                                    </select>
                                    @error('category')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="sku" class="form-control" value="AN-LC-102"
